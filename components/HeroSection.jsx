          ...
          >
            <h1 className="font-extrabold">
              ...
              <TypeWritter
                ...
                onInit={(typewriter) => {
                    typewriter
                    .typeString`<span style="color:#FF77FF">Data Analysit</span>`
                    .pauseFor(1500)
                    .deleteAll()
            ...
            <p className="overline text-gray-300 pt-8 text-base sm:text-lg mb-6 lg:text-xl">
              ...
              <Link
                href="https://drive.google.com/file/d/1bv9qYVBmj_DoTzUnYwpRyVL0CVF7-88X/view?usp=drive_link"
